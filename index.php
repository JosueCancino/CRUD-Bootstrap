...
<body>
            ...
            <div class="col-md-12">
                <h1 class="text-center">
                    <span class="float-start">
                        ...
                        <a href="#" onclick="modalGestionTiposContrato()" class="btn btn-success" title="Registrar Nuevo Tipo Contrato">
    ...
    <script src="assets/js/addTipoContrato.js"></script>
    <script src="assets/js/gestionContratos.js"></script>
